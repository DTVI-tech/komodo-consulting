...
const serviceData: Record<string, { label: string; title: string; subtitle: string; benefits: string[]; features: { title: string; description: string }[] }> = {
  ...
  "dedicated-teams": {
    ...
    title: "Outsourced teams, assembled and ready to work",
    subtitle: "Komodo provides a structured team with the right mix of roles — you retain full ownership of priorities, planning, and product direction.",
    benefits: [
      "Multi-role team composition",
      "Optional team lead included",
      "You own priorities and direction",
      "Aligned to your tools and workflows",
      "Scalable and flexible structure",
      "Full IP ownership retained",
    ],
    features: [
      { title: "Team Assembly", description: "We build the right team composition based on your technology stack, delivery needs, and ways of working." },
      { title: "Your Management, Our Capacity", description: "The team operates under your direction. Komodo provides the people, structure, and operational support — you set the agenda." },
      { title: "Transparent Operations", description: "Clear communication, regular availability updates, and straightforward scaling when your needs change." },
    ],
  },
  "nearshore-portugal": {
